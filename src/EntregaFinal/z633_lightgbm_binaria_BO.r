...
kBO_iter  <- 66   #cantidad de iteraciones de la Optimizacion Bayesiana

# ATENCION  si NO se quiere utilizar  undersampling  se debe  usar  kundersampling <- 1.0
kundersampling  <- 0.41   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
...
kdataset       <- "./exp/datasets/dataset_7133.csv.gz"         # El dataset generado con Feature Engineering
ksemilla_azar  <- 200003  #Aqui poner la propia semilla
kexperimento   <- "HT6330_13"
