...
kdataset       <- "./datasets/dataset_7133.csv.gz"
...
kexperimento   <- "KA8440_10"

ksemilla_primos  <-  200003
ksemillerio  <- 100

kmax_bin           <-    31
klearning_rate     <-    0.242019833615632
knum_iterations    <-   372
knum_leaves        <-   781
kmin_data_in_leaf  <-   3327
kfeature_fraction  <-    0.725588746117428
